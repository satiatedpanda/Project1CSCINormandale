...
person2 = {"Dawn: PLAYER NAME, I got a funny text from Cameron. He said you’re "
           "not\n going to the party tonight. I told him that was a pretty good" 
          " joke but he\n says he’s serious, so how about you set the record "
          "straight for the both of us.": 
          [["1) Ugh… He’s right?", score], 
           ["2) Okay first, you’re at an 11 when this should be a 4 
            "conversation, and\n   second, yeah I’m staying in tonight.",
            score2], 
           ["3) I’m just not really feeling it tonight.", score3]]}, #Dawn - bully
    #intended answer weights: 1 = medium impact, 2 = high, 3 = light
    {"Dawn: Pretty sure the last time you hung out with all of us was at the "
     "beginning\nof the month. We all tried making breakfast with Cameron’s "
     "grandma’s prehistoric\nwaffle pan and it almost burned a hole in the" 
     "counter.": 
     [["1) That only happened because Cameron’s an idiot.", score], 
      ["2) Y’know, I think waffles are an acceptable reason to cause a house "
       "fire.", score2], 
      ["3) That wasn’t our best idea.", score3]]},
